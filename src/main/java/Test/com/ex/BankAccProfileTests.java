...
public class BankAccProfileTests {
    ...
    private BankProfile prof = new BankProfile("hello", "h@gmail.com","Hello World", "100-10-1000", "Programmer");
    //String username, String email, String fullname, String ssn, String employment,
    ...
    private BankProfile prof2 = new BankProfile("hello2", "h2@gmail.com", "My World", "100-00-1010", "Nothing","" +
            "Her World", "111-11-1111", "Something");

    //String username, String accountNumber, double startingBalance, Integer accountType
    private BankAccount acc = new BankAccount("hello", "1", 0, 1);
    private BankAccount acc2 = new BankAccount("hello2", "2", 0, 2);
